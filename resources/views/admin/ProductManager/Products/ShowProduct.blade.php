                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                                        <a href="{{ route('Products.ShowProductDetail', $product->id) }}" class="btn btn-info mb-2 w-100">Xem</a>
                                                        <a href="{{ route('Products.EditProduct', $product->id) }}" class="btn btn-warning mb-2 w-100">Sửa</a>
                                                        @if (auth()->user() && auth()->user()->role)
                                                            <form action="{{ route('Products.DestroyProduct', $product->id) }}" method="POST" style="width: 100%;">
                                                                @csrf
                                                                @method('DELETE')
