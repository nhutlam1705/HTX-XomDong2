                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($introduction->image)
                                                        <img src="{{ asset('storage/' . $introduction->image) }}" alt="{{ $introduction->image }}" style="width: 150px; height:120px;">
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                                        ...
                                                        <form action="{{ route('introductions.approve', $introduction->id) }}" method="POST" style="width: 100%;">
                                                            @csrf
                                                            <button type="submit" class="btn btn-success mb-2 w-100">Duyệt</button>
                                                        </form>
                                                        <form action="{{ route('introductions.reject', $introduction->id) }}" method="POST" style="width: 100%;">
                                                            @csrf
                                                            @method('PATCH')
